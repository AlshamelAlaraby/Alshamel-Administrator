(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_helper_Export2Excel_js"],{

/***/ "./resources/js/helper/Export2Excel.js":
/*!*********************************************!*\
  !*** ./resources/js/helper/Export2Excel.js ***!
  \*********************************************/
...
function sheet_from_array_of_arrays(data, opts) {
  ...
  for (var R = 0; R != data.length; ++R) {
    for (var C = 0; C != data[R].length; ++C) {
      ...
      var cell_ref = xlsx__WEBPACK_IMPORTED_MODULE_1__["default"].utils.encode_cell({
        c: C,
        r: R
      });
      if (typeof cell.v === 'number') cell.t = 'n';else if (typeof cell.v === 'boolean') cell.t = 'b';else if (cell.v instanceof Date) {
        cell.t = 'n';
        cell.z = xlsx__WEBPACK_IMPORTED_MODULE_1__["default"].SSF._table[14];
        cell.v = datenum(cell.v);
      } else cell.t = 's';
      ws[cell_ref] = cell;
    }
  }
  if (range.s.c < 10000000) ws['!ref'] = xlsx__WEBPACK_IMPORTED_MODULE_1__["default"].utils.encode_range(range);
  return ws;
}
function Workbook() {
...
function export_table_to_excel(id) {
  ...
  var wbout = xlsx__WEBPACK_IMPORTED_MODULE_1__["default"].write(wb, {
    bookType: 'xlsx',
    bookSST: false,
    type: 'binary'
  });
...
function export_json_to_excel() {
  ...
  if (merges.length > 0) {
    ...
    merges.forEach(function (item) {
      ws['!merges'].push(xlsx__WEBPACK_IMPORTED_MODULE_1__["default"].utils.decode_range(item));
    });
  }
  if (autoWidth) {
    /*设置worksheet每列的最大宽度*/
