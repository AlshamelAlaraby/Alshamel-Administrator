...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("company.company")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.module_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("module.module")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.allowed_users_no ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
    ...
    on: {
      click: function click($event) {
        _vm.companyModules.sort(_vm.sortNumber("allowed_users_no"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    on: {
      click: function click($event) {
        _vm.companyModules.sort(_vm.SortDate("end_date"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
