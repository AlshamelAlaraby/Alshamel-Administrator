...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/partners?page=".concat(page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data.data;
          ...
          _c("div", { staticClass: "card" }, [
            _c(
              ...
              [
                ...
                _c(
                  "div",
                  { staticClass: "table-responsive mb-0 custom-table-theme" },
                  [
                    _c(
                      "table",
                      {
                ...
                _vm._v(" "),
                _c("Pagination", {
                  attrs: { data: _vm.partnersPagination },
