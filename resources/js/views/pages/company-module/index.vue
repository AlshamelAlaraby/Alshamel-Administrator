      ...
      ExportExcel(type, fn, dl) {
          ...
          setTimeout(()=>{
              ...
              if (dl){
                  ...
                  XLSX.writeFile(wb, fn || (('Company Module' + '.'|| 'SheetJSTableExport.') + (type || 'xlsx')));
              }
              this.enabled3 = true;
          },100);
      }
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            companyModulesPagination.current_page == 1 ? 'none' : '',
                        }"
                        @click.prevent="
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid':
                            $v.create.allowed_users_no.$error || errors.allowed_users_no,
                          'is-valid':
                      ...
                      <template v-if="errors.allowed_users_no">
                        <ErrorMessage
                          v-for="(errorMessage, index) in errors.allowed_users_no"
                          :key="index"
                          >{{ errorMessage }}</ErrorMessage
                        >
                      </template>
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="companyModules.sort(sortNumber('allowed_users_no'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.end_date">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="companyModules.sort(SortDate('end_date'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="companyModules.sort(SortDate('-end_date'))"
