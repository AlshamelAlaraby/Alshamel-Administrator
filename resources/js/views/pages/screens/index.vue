...
export default {
    ...
    methods: {
        ...
        getData(page = 1){
            ...
            adminApi.get(`/screens?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
                    this.screens = l.data;
        ...
        getDataCurrentPage(){
            if(this.current_page <= this.screensPagination.last_page && this.current_page != this.screensPagination.current_page && this.current_page){
                ...
                adminApi.get(`/screens?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                    .then((res) => {
                        let l = res.data;
                        this.screens = l.data;
                        this.screensPagination = l.pagination;
        ...
        AddSubmit(){
            ...
            if (this.$v.create.$invalid) {
                ...
                this.errors = {};
                this.is_disabled = false;
                adminApi.post(`/screens`,this.create)
                    .then((res) => {
                        this.getData();
        ...
        editSubmit(id){
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                let {name,name_e,title,title_e,serial_id} = this.edit;
                adminApi.put(`/screens/${id}`,{name,name_e,title,title_e,serial_id})
                    .then((res) => {
                            ...
                            <div class="col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                ...
                                <div class="d-inline-block" style="width: 22.2%;">
                                    ...
                                    <b-dropdown variant="primary" :text="$t('general.searchSetting')" ref="dropdown" class="btn-block setting-search">
                                        ...
                                        <b-form-checkbox v-model="filterSetting" value="title" class="mb-1">{{ $t('general.title') }}</b-form-checkbox>
                                        <b-form-checkbox v-model="filterSetting" value="title_e" class="mb-1">{{ $t('general.title_en') }}</b-form-checkbox>
                                    </b-dropdown>
                                    <!-- Basic dropdown -->
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:15px;">
                                            {{ screensPagination.from }}-{{ screensPagination.to }} / {{ screensPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':screensPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(screensPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':screensPagination.last_page == screensPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(screensPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div dir="rtl">
                                                <input
                                                    ...
                                                    :class="{ 'is-invalid':$v.create.name.$error || errors.name,'is-valid':!$v.create.name.$invalid && !errors.name}"
                                                    id="field-1"
                                                />
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.name">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="screens.sort(sortString('name'))"></i>
                                                <i class="fas fa-arrow-down" @click="screens.sort(sortString('-name'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="screens.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down" @click="screens.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                    </th>
